...
const defaultTicketTiers: TicketTierBase[] = [
  {
    id: 'vip',
    name: 'VIP',
    currency: 'PEN',
...
let eventsDb: AdminEvent[] = [
  {
    ...
    like: 2410,
    noInteres: 62,
    comentario: ['¡Line up confirmado! Prepárate para una noche inolvidable.'],
    ticketTiers: [
      {
        id: 'vip',
        name: 'VIP',
  ...
  },
  {
    ...
    like: 185,
    noInteres: 12,
    comentario: ['La agenda preliminar estará disponible el 15 de agosto.'],
    ticketTiers: [
      {
        id: 'vip',
        name: 'VIP',
...
export { adminEventApi, defaultTicketTiers, eventCategories, organizers };
