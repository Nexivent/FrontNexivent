...
const Footer: React.FC = () => {
  ...
  const hideTickets = isOrganizer || isAdmin;
    ...
    <footer>
      <div className='container'>
        ...
        <div className='links'>
          ...
          <Link href='/venues' className='white'>Locales</Link>

          {!hideTickets && (
            <Link href='/members/tickets' className='white'>Mis tickets</Link>
          )}
        ...
        <div className='links'>
          ...
          <Link href='/news' className='white'>Nosotros</Link>
          <Link href='/contact' className='white'>Contactanos</Link>
