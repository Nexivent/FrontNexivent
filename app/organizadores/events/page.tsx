...
const OrganizersEventsPage = () => (
  <Master>
    <Section className='gray-background hero-offset'>
      <div className='container'>
        <div className='admin-header'>
          <Heading type={1} color='white' text='Panel de eventos para organizadores' />
          <p className='gray'>
...
const title = 'Panel de eventos para organizadores';
const canonical = 'https://nexivent.com/organizadores/events';
const description =
...
export default OrganizersEventsPage;
